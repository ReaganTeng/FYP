    ...
    public class ProCamera2DRoomsEditor : Editor
    {
        ...
        void OnSceneGUI()
        {
            ...
            for (int i = 0; i < proCamera2DRooms.Rooms.Count; i++)
            {
                ...
                if (Handles.Button(proCamera2DRooms.Rooms[i].Dimensions.position, Quaternion.LookRotation(VectorHVD(0, 0, 1)), buttonSize, buttonSize, Handles.RectangleHandleCap))
                {
